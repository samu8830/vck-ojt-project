          ...
          <section className="card2">
            <section className="txt1">
              ...
              <h1 className="centered">
                ...
                College!<br/>
                 <h5>Your journey to excellence starts here.</h5>
            ...
            <h3>Campus Life & Facilities</h3>
             <hr/>
            <div className="im-hm">
                          <img className="hm-img-fac" src="images/students-studying.jpg"></img>
            <img className="hm-img-fac" src="./images/campus-life.jpg"></img>
            </div>
            <div className="txt-bot-hm">
            <p>Explore our vibrant campus and state-of-the-art facilities designed to enhance your learning experience and personal growth.</p>
              <p>Ready to explore our courses?</p>
              <a className="but-bot-hm" href="/courses">Explore Courses</a>
            </div>
          </section>
        </main>
      </div>
